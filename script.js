...
function calculatePlanTresorerie() {
  ...
  // Mise à jour dynamique de l'en-tête
...
function generatePdfReport() {
  ...
  // Déterminer le scénario de préconisation
  const scenarioPlan = document.getElementById("scenarioPlan").value;
  ...
  // PAGE 2 : Détails par mois (année 1)
  pdf.addPage();
  pdf.setFontSize(14);
  ...
  // PAGE 3 : Graphique des productions
  pdf.addPage();
  pdf.setFontSize(14);
